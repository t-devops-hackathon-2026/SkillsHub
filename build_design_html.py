"""docs/designs/ 配下の各仕様書(.md)から同名の HTML 仕様書を生成する。
...
aside .docs{margin:0 8px 20px;padding-bottom:16px;border-bottom:1px solid var(--line)}
aside .docs a{font-size:12.5px;padding:5px 8px}
...
aside a.current{color:var(--brand);font-weight:700}
...
<div class="layout">
  <aside>
    <div class="title">SkillsHub 設計書</div>
    <div class="docs">
      <a href="../overview/overview.html" data-doc="overview">総括</a>
      <a href="../step1/step1.html" data-doc="step1">Step 1: 集めて探せる</a>
      <a href="../step2/step2.html" data-doc="step2">Step 2: 改善提案</a>
      <a href="../step3/step3.html" data-doc="step3">Step 3: 利用記録・品質</a>
    </div>
    <nav id="toc"></nav>
  </aside>
...
// 仕様書間のリンクは .md と .html を併設しているので HTML 側へ付け替える
content.querySelectorAll('a[href]').forEach(a=>{
  const h=a.getAttribute('href');
  if(h && !/^https?:/.test(h) && /\.md(#|$)/.test(h)) a.setAttribute('href', h.replace(/\.md(#|$)/, '.html$1'));
});
document.querySelectorAll('aside .docs a').forEach(a=>{
  if(a.dataset.doc==='__DOC__') a.classList.add('current');
});
