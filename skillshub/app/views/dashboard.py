...
def render() -> None:
    ...
    keyword, freshness, tags, sort_by = _render_filters(all_tags)
    filtered_skills = services.list_skills(keyword=keyword, freshness=freshness, tags=tags, sort_by=sort_by)
